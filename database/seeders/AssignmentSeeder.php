...
class AssignmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $assignments = [
            ...
            '05.00 Землі іншого природоохоронного призначення',
            ...
            '11.04 Для розміщення та експлуатації основних, підсобних і допоміжних будівель та споруд технічної інфраструктури',
            ...
            '12.10 Для цілей підрозділів 12.01-12.09, 12.11 та для збереження та використання земель природно-заповідного фонду',
            ...
            '13.04 Для цілей підрозділів 13.01-13.03, 13.05 та для збереження і використання земель природно-заповідного фонду',
            ...
            '19.00 Для цілей підрозділів 16.00-18.00 та для збереження та використання земель природно-заповідного фонду',
        ];
